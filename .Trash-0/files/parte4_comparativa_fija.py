...
class MNISTTrainer:
    def __init__(self):
        ...
        # HIPERPARÁMETROS (igual que el Ing. Deras)
        self.input_size = 784
        self.hidden_size = 128  # ← MISMA arquitectura que el Ing.
        self.output_size = 10
        self.learning_rate = 0.001  # ← MISMO learning rate
        self.epochs = 3  # ← MISMO número de épocas
        self.batch_size = 128  # ← MISMO batch size
    ...
    def preprocess_data(self):
        """Preprocesar datos (igual que el Ing. Deras)"""
    ...
    def save_model(self, filename):
        """Guardar modelo en formato JSON (igual que el Ing. Deras)"""
        model_config = {
            "input_shape": [28, 28, 1],
...
def main():
    ...
    print("=" * 50)
    print("Misma configuración que el Ing. Deras")
    print("=" * 50)
    ...
    # 7. Mostrar resumen exacto como el Ing. Deras
    print("\n" + "=" * 50)
